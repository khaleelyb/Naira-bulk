      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            >
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-green-600 to-emerald-500 flex items-center justify-center shadow-md shadow-green-200 dark:shadow-green-900/40 group-hover:shadow-green-300 transition-shadow">
                {/* Naira ₦ icon */}
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" xmlns="http://www.w3.org/2000/svg">
                  <text x="3" y="18" fontSize="16" fontWeight="bold" fill="white" fontFamily="Arial">₦</text>
                </svg>
              </div>
              <div className="block">
                <span className="font-bold text-gray-900 dark:text-white text-lg leading-none tracking-tight">Naira</span>
                <span className="font-bold text-green-600 dark:text-green-400 text-lg leading-none tracking-tight">Bulk</span>
              </div>
            </button>

            {/* Search bar - desktop */}
            <div className="hidden md:flex flex-1 max-w-xl relative">
              <div className="w-full flex items-center bg-gray-50 dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-green-400 focus-within:border-green-400 transition-all">
            ...
            <div className="flex items-center gap-2">
              ...
              {currentUser ? (
                <button
                  ...
                  className={`flex items-center gap-2 pl-1 pr-3 py-1 rounded-full transition-all hover:bg-gray-100 dark:hover:bg-gray-800 ${activePage === 'profile' ? 'ring-2 ring-green-400' : ''}`}
                >
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white font-semibold text-sm px-4 py-2 rounded-xl shadow-md shadow-green-200 dark:shadow-green-900/30 hover:shadow-green-300 transition-all duration-200"
              >
          ...
          <div className="md:hidden pb-3">
            <div className="flex items-center bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-green-400 transition-all">

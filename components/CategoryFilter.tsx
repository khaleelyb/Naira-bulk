      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        ...
        <div className="grid grid-cols-5 sm:grid-cols-7 md:grid-cols-10 gap-1 sm:gap-2">
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-start gap-1.5 px-1 py-2.5 rounded-xl text-center transition-all duration-200 group ${
                  isActive
                    ? 'bg-orange-50 dark:bg-orange-900/20 ring-2 ring-orange-400 dark:ring-orange-500'
              ...
              >
                <div className={`w-9 h-9 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center transition-all duration-200 text-xl sm:text-2xl shadow-sm ${
                  isActive
                    ? 'bg-orange-500 shadow-orange-200 dark:shadow-orange-900/50 scale-105'
                    : 'bg-gray-100 dark:bg-gray-800 group-hover:bg-orange-100 dark:group-hover:bg-orange-900/20 group-hover:scale-105'
                }`}>
                  {emoji}
                </div>
          ...
          {categories.length > PREVIEW_COUNT && (
            ...
            >
              <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center group-hover:bg-orange-100 dark:group-hover:bg-orange-900/20 group-hover:scale-105 transition-all duration-200">
                <svg
                  className={`w-4 h-4 text-gray-500 dark:text-gray-400 group-hover:text-orange-500 transition-transform duration-300 ${showAll ? 'rotate-180' : ''}`}
                  fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
              </div>
              <span className="text-[9px] sm:text-[10px] font-medium text-orange-500 dark:text-orange-400 leading-tight">

        ...
        {loading ? (
          ...
          >
            ...
            <div className="bg-white p-10 rounded-[32px] border border-slate-200 shadow-soft overflow-x-auto">
              <div className="min-w-[700px] flex justify-between relative px-4">
                {/* Connector Line */}
                ...
                {STATUS_STEPS.map((step, idx) => {
                  ...
                  return (
                    <div key={step} className="flex flex-col items-center gap-5 relative z-10 w-28">
                      ...
                      <span className={`text-[10px] font-bold uppercase tracking-widest text-center px-1 ${isCurrent ? 'text-[#FF5A00]' : isCompleted ? 'text-slate-900' : 'text-slate-400'}`}>
                        {step}
                      </span>
                    </div>
                  );

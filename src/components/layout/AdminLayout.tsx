...
import { LayoutDashboard, Globe, Package, Users, Settings, LogOut, ChevronRight, BarChart } from 'lucide-react';
          ...
          <div className="h-16 bg-white border-b border-slate-200 hidden lg:flex items-center justify-end px-10 gap-6 shadow-sm sticky top-0 z-10">
            <div className="flex items-center gap-3">
               <div className="text-right">
                  <p className="text-[10px] font-bold text-slate-900 uppercase tracking-widest leading-none">Security Officer</p>
